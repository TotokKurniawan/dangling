...
<head>
    ...
    <link href="{{ asset('assetsfitur/css/styles.css') }}" rel="stylesheet" />
</head>
...
<body id="page-top">
                    ...
                    <div class="mb-5 mb-lg-0 text-center text-lg-start">
                        ...
                        <div class="d-flex flex-column flex-lg-row align-items-center">
                            <a class="me-lg-3 mb-4 mb-lg-0" href="#!"><img class="app-badge"
                                    src="{{ asset('assetsfitur/img/google-play-badge.svg') }}" alt="..." /></a>
                            <a href="#!"><img class="app-badge"
                                    src="{{ asset('assetsfitur/img/app-store-badge.svg') }}" alt="..." /></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
        ...
        <div class="container px-5">
            <div class="row gx-5 justify-content-center">
                <div class="col-xl-8">
                    ...
                    <img src="{{ asset('assetsfitur/img/tnw-logo.svg') }}" alt="..." style="height: 3rem" />
                </div>
            </div>
        </div>
    </aside>
                        ...
                        <div class="device-wrapper">
                            <div class="device" data-device="iPhoneX" data-orientation="portrait"
                                ...
                                <div class="screen bg-black">
                                    <video muted="muted" autoplay="" loop=""
                                        style="max-width: 100%; height: 100%">
                                        <source src="{{ asset('assetsfitur/img/demo-screen.mp4') }}"
                                            type="video/mp4" />
                                    </video>
                                </div>
                            </div>
    ...
    <section class="cta">
        <div class="cta-content">
            <div class="container px-5">
                ...
                <a class="btn btn-outline-light py-3 px-4 rounded-pill" href="" target="_blank">Download for
                    free</a>
            </div>
        </div>
    </section>
    ...
    <script src="{{ asset('assetsfitur/js/scripts.js') }}"></script>
